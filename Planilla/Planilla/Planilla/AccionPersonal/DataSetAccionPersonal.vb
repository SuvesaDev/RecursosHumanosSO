...
Public Class DataSetAccionPersonal
    ...
    Public Class AccionPersonalDataTable
        ...
        Public Overloads Function AddAccionPersonalRow(ByVal Num_Accion As Long, ByVal parentEmpleadoRowByEmpleadoAccionPersonal As EmpleadoRow, ByVal Nombre_Empleado As String, ByVal Puesto As String, ByVal parentAccionRowByAccionAccionPersonal As AccionRow, ByVal Fecha As Date, ByVal Observaciones As String, ByVal RigeDesde As Date, ByVal RigeHasta As Date, ByVal DiasaDescontar As Double, ByVal HechoPor As String, ByVal NombreUsuario As String, ByVal Anula As Boolean) As AccionPersonalRow
            Dim rowAccionPersonalRow As AccionPersonalRow = CType(Me.NewRow,AccionPersonalRow)
            rowAccionPersonalRow.ItemArray = New Object() {Num_Accion, parentEmpleadoRowByEmpleadoAccionPersonal(0), Nombre_Empleado, Puesto, parentAccionRowByAccionAccionPersonal(0), Fecha, Observaciones, RigeDesde, RigeHasta, DiasaDescontar, HechoPor, NombreUsuario, Anula}
