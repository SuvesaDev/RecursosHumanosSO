...
Public Class DsLiquidacion
    ...
    Public Class EmpleadoDataTable
        ...
        Public Overloads Function AddEmpleadoRow(ByVal Identificacion As String, ByVal Nombre As String, ByVal Fecha_Ingreso As Date, ByVal Fecha_Salida As Date, ByVal Diario As Boolean, ByVal Semana As Boolean, ByVal Quincena As Boolean, ByVal Mensual As Boolean, ByVal Salario As Double, ByVal Hora As Boolean, ByVal Cod_Estado As Integer, ByVal Cod_Moneda As Integer) As EmpleadoRow
            Dim rowEmpleadoRow As EmpleadoRow = CType(Me.NewRow,EmpleadoRow)
            rowEmpleadoRow.ItemArray = New Object() {Identificacion, Nombre, Fecha_Ingreso, Fecha_Salida, Diario, Semana, Quincena, Mensual, Salario, Hora, Cod_Estado, Cod_Moneda}
    ...
    Public Class MonedaDataTable
        ...
        Public Overloads Function AddMonedaRow(ByVal CodMoneda As Integer, ByVal MonedaNombre As String, ByVal ValorCompra As Double, ByVal ValorVenta As Double) As MonedaRow
            ...
            rowMonedaRow.ItemArray = New Object() {CodMoneda, MonedaNombre, ValorCompra, ValorVenta}
