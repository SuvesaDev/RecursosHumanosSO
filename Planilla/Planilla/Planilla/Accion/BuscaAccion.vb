...
#Region "buscar"
    Sub buscar()
        ...
        Dim str As String = "select * from Accion where Nombre like '%" & Me.txtBusqueda.Text & "%'"
        Dim fu As New cFunciones
        Try
            Me.DataSetBuscaAccion1.Clear()
            fu.Cargar_Tabla_Generico(Me.AdapterAccion, str)
            Me.AdapterAccion.Fill(Me.DataSetBuscaAccion1.Accion)
