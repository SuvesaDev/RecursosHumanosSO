...
Public Class DataSetAccion
    ...
    Public Class EmpleadoDataTable
        ...
        Public Overloads Function AddEmpleadoRow( _
            ...
            rowEmpleadoRow.ItemArray = New Object() {Identificacion, Nombre, Puesto, Salario, Hora, Diario, Semana, Quincena, Mensual, Estado_Civil, Hijos, Cod_Nacionalidad, Fecha_Nacimiento, Edad, Telefono1, Telefono2, Email, Direccion, Fecha_Ingreso, Fecha_Salida, Cod_Departamento}
    ...
    Public Class UsuariosDataTable
        ...
        Private columnAnuAjustecCobrar As DataColumn
        ...
        Friend ReadOnly Property AnuAjustecCobrarColumn As DataColumn
            Get
        ...
        Public Overloads Function AddUsuariosRow( _
            ...
            rowUsuariosRow.ItemArray = New Object() {Cedula, Nombre, Clave_Entrada, Clave_Interna, Perfil, Anu_Venta, Anu_Cotizacion, CambiarPrecio, Aplicar_Desc, Exist_Negativa, RecibosDinero, AnuRecibos, VariarIntereses, Porc_Desc, Porc_Precio, Foto, Abrir_Credito, AnuAjustecCobrar}
        ...
        Friend Sub InitVars()
            ...
            Me.columnAnuAjustecCobrar = Me.Columns("AnuAjustecCobrar")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnAnuAjustecCobrar = New DataColumn("AnuAjustecCobrar", GetType(System.Boolean), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnAnuAjustecCobrar)
