...
Public Class DsEmpleado
    ...
    Public Class DistribucionContableDataTable
        ...
        Public Overloads Function AddDistribucionContableRow(ByVal EmpleadoIdentificacion As String, ByVal IdDepartamento As Integer, ByVal Departamento As String, ByVal Porcentaje As Single) As DistribucionContableRow
            Dim rowDistribucionContableRow As DistribucionContableRow = CType(Me.NewRow,DistribucionContableRow)
            rowDistribucionContableRow.ItemArray = New Object() {EmpleadoIdentificacion, IdDepartamento, Departamento, Porcentaje}
