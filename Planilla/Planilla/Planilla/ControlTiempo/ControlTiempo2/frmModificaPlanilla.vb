...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GridControl1.Size = New System.Drawing.Size(776, 168)
        ...
        Me.SqlInsertCommand11.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ContactoConCliente", System.Data.SqlDbType.Bit, 1, "ContactoConCliente"))
        ...
        "ena = @Quincena, Mensual = @Mensual, Cod_Estado = @Cod_Estado, Foto = @Foto, Con" & _
        "tactoConCliente = @ContactoConCliente, CuentaBancaria = @CuentaBancaria WHERE (I" & _
        "dentificacion = @Original_Identificacion) AND (Cod_Departamento = @Original_Cod_" & _
        "Departamento) AND (Cod_Estado = @Original_Cod_Estado) AND (Cod_Moneda = @Origina" & _
        "l_Cod_Moneda) AND (Cod_Nacionalidad = @Original_Cod_Nacionalidad) AND (ContactoC" & _
        "onCliente = @Original_ContactoConCliente) AND (CuentaBancaria = @Original_Cuenta" & _
        "Bancaria OR @Original_CuentaBancaria IS NULL AND CuentaBancaria IS NULL) AND (Di" & _
        "ario = @Original_Diario) AND (Direccion = @Original_Direccion) AND (Edad = @Orig" & _
        "inal_Edad) AND (Email = @Original_Email) AND (Estado_Civil = @Original_Estado_Ci" & _
        "vil) AND (Fecha_Ingreso = @Original_Fecha_Ingreso) AND (Fecha_Nacimiento = @Orig" & _
        "inal_Fecha_Nacimiento) AND (Fecha_Salida = @Original_Fecha_Salida) AND (Femenino" & _
        " = @Original_Femenino) AND (Hijos = @Original_Hijos) AND (Hora = @Original_Hora)" & _
        " AND (Masculino = @Original_Masculino) AND (Mensual = @Original_Mensual) AND (No" & _
        "mbre = @Original_Nombre) AND (Puesto = @Original_Puesto) AND (Quincena = @Origin" & _
        "al_Quincena) AND (Salario = @Original_Salario) AND (Semana = @Original_Semana) A" & _
        "ND (Telefono1 = @Original_Telefono1) AND (Telefono2 = @Original_Telefono2); SELE" & _
        "CT Identificacion, Nombre, Estado_Civil, Hijos, Cod_Nacionalidad, Fecha_Nacimien" & _
        "to, Edad, Telefono1, Telefono2, Email, Direccion, Puesto, Fecha_Ingreso, Fecha_S" & _
        "alida, Salario, Cod_Departamento, Masculino, Femenino, Cod_Moneda, Hora, Diario," & _
        " Semana, Quincena, Mensual, Cod_Estado, Foto, ContactoConCliente, CuentaBancaria" & _
        " FROM Empleado WHERE (Identificacion = @Identificacion)"
        ...
        Me.SqlUpdateCommand11.Parameters.Add(New System.Data.SqlClient.SqlParameter("@ContactoConCliente", System.Data.SqlDbType.Bit, 1, "ContactoConCliente"))
        ...
        Me.SqlUpdateCommand11.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ContactoConCliente", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "ContactoConCliente", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.SqlDeleteCommand11.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_ContactoConCliente", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "ContactoConCliente", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.ClientSize = New System.Drawing.Size(778, 256)
...
#End Region
    ...
    Private Sub Buscar()
        Try
            ...
            Id = Fx.BuscarDatos("Select Id_Planilla, Cedula, Nombre from Planilla_Detalle", "Cedula", "Buscar Planilla...")
        ...
        If x >= 0 Then
            Try
                ...
                For J = 0 To Me.DsModificaPlanilla1.Empleado_Deducciones.Rows.Count - 1
                    'Tipo = Me.DsModificaPlanilla1.Deducciones.Rows(x).Item("Tipo")

                    'Descripcion1 = Me.DsModificaPlanilla1.Deducciones.Rows(x).Item("Descripcion")
                        ...
                        If Me.DsModificaPlanilla1.Adelantos.Rows(J).Item("Anulado") = False Then
                            ...
                            If Me.DsModificaPlanilla1.Adelantos.Rows(J).Item("Adelanto") Then  'cambio =true
                                ...
                                If FechaI.Date <= fecha.Date And FechaF.Date >= fecha.Date Then
                                    Adelanto = TablaModifica.Rows(x).Item("Adelantos") 'Me.DsModificaPlanilla1.Adelantos.Rows(J).Item("Monto") Cambios
                ...
                End If
                Cedula = TablaModifica.Rows(x).Item("Cedula")
                If cierre = True Then
                    ParametroRenta()
