...
Public Class DsModificaPlanilla
    Inherits DataSet
    ...
    Public Class Planilla_DetalleDataTable
        ...
        Private columnModificado As DataColumn
        ...
        Friend ReadOnly Property ModificadoColumn As DataColumn
            Get
        ...
        Public Overloads Function AddPlanilla_DetalleRow( _
            ...
            rowPlanilla_DetalleRow.ItemArray = New Object() {Nothing, parentPlanillaRowByPlanillaPlanilla_Detalle(0), Cedula, Nombre, Puesto, Salario, FormaPago, Ordinaria, Extra, Doble, SalarioBruto, Adelantos, Prestamos, Renta, TotalDeducciones, SalarioNeto, Cod_Moneda, Modificado}
        ...
        Friend Sub InitVars()
            ...
            Me.columnModificado = Me.Columns("Modificado")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnModificado = New DataColumn("Modificado", GetType(System.Boolean), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnModificado)
    ...
    Public Class EmpleadoDataTable
        ...
        Public Overloads Function AddEmpleadoRow( _
            ...
            rowEmpleadoRow.ItemArray = New Object() {Identificacion, Nombre, Estado_Civil, Hijos, Cod_Nacionalidad, Fecha_Nacimiento, Edad, Telefono1, Telefono2, Email, Direccion, Puesto, Fecha_Ingreso, Fecha_Salida, Salario, Cod_Departamento, Masculino, Femenino, Cod_Moneda, Hora, Diario, Semana, Quincena, Mensual, Cod_Estado, Foto, ContactoConCliente, CuentaBancaria}
