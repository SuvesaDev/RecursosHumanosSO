...
Public Class DsControl
    ...
    Public Class AccionPersonalDataTable
        ...
        Public Overloads Function AddAccionPersonalRow(ByVal Num_Accion As Long, ByVal Id_Empleado As String, ByVal Nombre_Empleado As String, ByVal Puesto As String, ByVal Id_Accion As Integer, ByVal Fecha As Date, ByVal Observaciones As String, ByVal RigeDesde As Date, ByVal RigeHasta As Date, ByVal DiasaDescontar As Double, ByVal HechoPor As String, ByVal Anula As Boolean) As AccionPersonalRow
            ...
            rowAccionPersonalRow.ItemArray = New Object() {Num_Accion, Id_Empleado, Nombre_Empleado, Puesto, Id_Accion, Fecha, Observaciones, RigeDesde, RigeHasta, DiasaDescontar, HechoPor, Anula}
    ...
    Public Class PlanillaDataTable
        ...
        Public Overloads Function AddPlanillaRow(ByVal Fecha As Date, ByVal FechaInicial As Date, ByVal FechaFinal As Date, ByVal CierreMes As Boolean, ByVal Ced_Usuario As String, ByVal Nombre_Usuario As String, ByVal Anulado As Boolean, ByVal Id_Proyecto As Integer) As PlanillaRow
            ...
            rowPlanillaRow.ItemArray = New Object() {Nothing, Fecha, FechaInicial, FechaFinal, CierreMes, Ced_Usuario, Nombre_Usuario, Anulado, Id_Proyecto}
