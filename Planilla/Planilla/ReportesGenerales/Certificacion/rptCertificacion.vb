...
Public Class rptCertificacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.rptCertificacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Encargado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCertificacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCertificacion = New rptCertificacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
