...
#End Region
    ...
    Private Sub BuscaAccionPersonal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.DateFechaInicio.DateTime = Now.Date
            Me.DateFechaFinal.DateTime = Now.Date
...
#End Region
    ...
    Private Sub cmbEmpleado_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles cmbEmpleado.KeyDown
        If e.KeyCode = Keys.F1 Then
            Dim cFunciones As New cFunciones
            Dim Identificacion As String

            Identificacion = cFunciones.BuscarDatos2("select Identificacion, Nombre, Fecha_Ingreso, Fecha_Salida, Diario, Semana, Quincena, Mensual, Hora, Salario from Empleado", "Nombre", " ORDER BY Nombre", "Buscar Empleado ...", SqlConnection1.ConnectionString)
           
            If Identificacion <> "" Then
                Me.cmbEmpleado.SelectedValue = Identificacion
            End If
        End If
    End Sub
End Class
