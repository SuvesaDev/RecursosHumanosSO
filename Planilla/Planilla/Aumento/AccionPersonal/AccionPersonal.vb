...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ToolBar1.Location = New System.Drawing.Point(0, 326)
        Me.ToolBar1.Name = "ToolBar1"
        Me.ToolBar1.Size = New System.Drawing.Size(536, 56)
        ...
        Me.txtAccionNº.Size = New System.Drawing.Size(80, 21)
        ...
        Me.txtObservaciones.Location = New System.Drawing.Point(0, 160)
        ...
        Me.pnlRige.Location = New System.Drawing.Point(0, 224)
        Me.pnlRige.Name = "pnlRige"
        Me.pnlRige.Size = New System.Drawing.Size(272, 64)
        ...
        Me.txtDiasDesc.Size = New System.Drawing.Size(72, 21)
        ...
        Me.Label12.Location = New System.Drawing.Point(280, 248)
        ...
        Me.Label14.Location = New System.Drawing.Point(280, 224)
        ...
        " @Original_Anula) AND (Cod_Estado = @Original_Cod_Estado) AND (DiasaDescontar = " & _
        "@Original_DiasaDescontar) AND (EstadoCambio = @Original_EstadoCambio) AND (Fecha" & _
        " = @Original_Fecha) AND (HechoPor = @Original_HechoPor) AND (Id_Accion = @Origin" & _
        "al_Id_Accion) AND (Id_Empleado = @Original_Id_Empleado) AND (NombreUsuario = @Or" & _
        "iginal_NombreUsuario) AND (Nombre_Empleado = @Original_Nombre_Empleado) AND (Obs" & _
        "ervaciones = @Original_Observaciones) AND (Puesto = @Original_Puesto) AND (RigeD" & _
        "esde = @Original_RigeDesde) AND (RigeHasta = @Original_RigeHasta)"
        ...
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DiasaDescontar", System.Data.SqlDbType.Float, 8, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "DiasaDescontar", System.Data.DataRowVersion.Original, Nothing))
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_EstadoCambio", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "EstadoCambio", System.Data.DataRowVersion.Original, Nothing))
        ...
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "INSERT INTO AccionPersonal(Id_Empleado, Nombre_Empleado, Puesto, Id_Accion, Fecha" & _
        ", Observaciones, RigeDesde, RigeHasta, DiasaDescontar, HechoPor, NombreUsuario, " & _
        "Anula, EstadoCambio, Cod_Estado) VALUES (@Id_Empleado, @Nombre_Empleado, @Puesto" & _
        ", @Id_Accion, @Fecha, @Observaciones, @RigeDesde, @RigeHasta, @DiasaDescontar, @" & _
        "HechoPor, @NombreUsuario, @Anula, @EstadoCambio, @Cod_Estado); SELECT Num_Accion" & _
        ", Id_Empleado, Nombre_Empleado, Puesto, Id_Accion, Fecha, Observaciones, RigeDes" & _
        "de, RigeHasta, DiasaDescontar, HechoPor, NombreUsuario, Anula, EstadoCambio, Cod" & _
        "_Estado FROM AccionPersonal WHERE (Num_Accion = @@IDENTITY)"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DiasaDescontar", System.Data.SqlDbType.Float, 8, "DiasaDescontar"))
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EstadoCambio", System.Data.SqlDbType.Bit, 1, "EstadoCambio"))
        ...
        "aciones, RigeDesde, RigeHasta, DiasaDescontar, HechoPor, NombreUsuario, Anula, E" & _
        "stadoCambio, Cod_Estado FROM AccionPersonal"
        Me.SqlSelectCommand1.Connection = Me.SqlConnection1
        '
        'SqlUpdateCommand1
        '
        Me.SqlUpdateCommand1.CommandText = "UPDATE AccionPersonal SET Id_Empleado = @Id_Empleado, Nombre_Empleado = @Nombre_E" & _
        "mpleado, Puesto = @Puesto, Id_Accion = @Id_Accion, Fecha = @Fecha, Observaciones" & _
        " = @Observaciones, RigeDesde = @RigeDesde, RigeHasta = @RigeHasta, DiasaDesconta" & _
        "r = @DiasaDescontar, HechoPor = @HechoPor, NombreUsuario = @NombreUsuario, Anula" & _
        " = @Anula, EstadoCambio = @EstadoCambio, Cod_Estado = @Cod_Estado WHERE (Num_Acc" & _
        "ion = @Original_Num_Accion) AND (Anula = @Original_Anula) AND (Cod_Estado = @Ori" & _
        "ginal_Cod_Estado) AND (DiasaDescontar = @Original_DiasaDescontar) AND (EstadoCam" & _
        "bio = @Original_EstadoCambio) AND (Fecha = @Original_Fecha) AND (HechoPor = @Ori" & _
        ...
        "Por, NombreUsuario, Anula, EstadoCambio, Cod_Estado FROM AccionPersonal WHERE (N" & _
        "um_Accion = @Num_Accion)"
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@DiasaDescontar", System.Data.SqlDbType.Float, 8, "DiasaDescontar"))
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@EstadoCambio", System.Data.SqlDbType.Bit, 1, "EstadoCambio"))
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_DiasaDescontar", System.Data.SqlDbType.Float, 8, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "DiasaDescontar", System.Data.DataRowVersion.Original, Nothing))
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_EstadoCambio", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "EstadoCambio", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.pnlPrincipal.Size = New System.Drawing.Size(536, 296)
        Me.pnlPrincipal.TabIndex = 254
        '
        'TxtNombreEmp
        '
        Me.TxtNombreEmp.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.DataSetAccionPersonal1, "AccionPersonal.Nombre_Empleado"))
        Me.TxtNombreEmp.Location = New System.Drawing.Point(192, 32)
        Me.TxtNombreEmp.Name = "TxtNombreEmp"
        Me.TxtNombreEmp.Size = New System.Drawing.Size(336, 20)
        ...
        Me.LinkLabel1.Location = New System.Drawing.Point(104, 120)
        Me.LinkLabel1.Name = "LinkLabel1"
        Me.LinkLabel1.Size = New System.Drawing.Size(296, 96)
        ...
        Me.txtUsuario.Location = New System.Drawing.Point(280, 264)
        ...
        Me.txtNombreUsuario.Location = New System.Drawing.Point(355, 264)
        ...
        Me.txtCedulaUsuario.Location = New System.Drawing.Point(404, 272)
        ...
        'CheckEstado
        '
        Me.CheckEstado.DataBindings.Add(New System.Windows.Forms.Binding("Checked", Me.DataSetAccionPersonal1, "AccionPersonal.EstadoCambio"))
        Me.CheckEstado.Location = New System.Drawing.Point(288, 112)
        ...
        'CBEstado
        '
        Me.CBEstado.DataBindings.Add(New System.Windows.Forms.Binding("SelectedValue", Me.DataSetAccionPersonal1, "AccionPersonal.Cod_Estado"))
        Me.CBEstado.DataSource = Me.DsEstado.Estado_Empleado
        Me.CBEstado.DisplayMember = "Descripcion"
        Me.CBEstado.Location = New System.Drawing.Point(408, 112)
        ...
        Me.SqlDeleteCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Salida", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "Salida", System.Data.DataRowVersion.Original, Nothing))
        '
        'SqlInsertCommand5
        '
        ...
        Me.SqlInsertCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Salida", System.Data.SqlDbType.Bit, 1, "Salida"))
        '
        'SqlSelectCommand5
        '
        ...
        'SqlUpdateCommand5
        '
        Me.SqlUpdateCommand5.CommandText = "UPDATE Estado_Empleado SET Descripcion = @Descripcion, Salida = @Salida WHERE (Co" & _
        ...
        Me.SqlUpdateCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Salida", System.Data.SqlDbType.Bit, 1, "Salida"))
        ...
        Me.SqlUpdateCommand5.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_Salida", System.Data.SqlDbType.Bit, 1, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "Salida", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.MaximumSize = New System.Drawing.Size(544, 700)
...
#End Region
    ...
    Private Sub AccionPersonal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            AdapterAccion.Fill(DataSetAccionPersonal1.Accion)
            AdapterEmpleado.Fill(DataSetAccionPersonal1.Empleado)
            AdapterEstado.Fill(DsEstado.Estado_Empleado)
            ...
            DataSetAccionPersonal1.AccionPersonal.Nombre_EmpleadoColumn.DefaultValue = " "
            ...
            Try
                ...
                If Me.CheckEstado.Checked = True Then
                    If Me.CBEstado.SelectedValue <> EstadoAnterior Then
                        ...
                        ElseIf Me.CBEstado.SelectedValue = 2 Then
...
#End Region
    ...
    Private Sub CargarInformacionEmpleado(ByVal codigo As String)
        ...
        If codigo <> Nothing Then
            rs = cConexion.GetRecorset(cConexion.Conectar("Planilla"), "SELECT Identificacion, Nombre, Puesto, Cod_Estado from Empleado where Identificacion ='" & codigo & "'")
            Try
                If rs.Read Then
                    TxtNombreEmp.Text = rs("Nombre")
                    txtDescripcionPuesto.Text = rs("Puesto")
                    EstadoAnterior = rs("Cod_Estado")
                    cmbAccion.Focus()
                Else
                    MsgBox("La identificación del Empleado no se encuentra", MsgBoxStyle.Information, "Atención...")
                    TxtNombreEmp.Text = "" : txtDescripcionPuesto.Text = ""
    ...
    Private Sub txtCodigoEmpleado_KeyDown1(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtCodigoEmpleado.KeyDown
        If e.KeyCode = Keys.F1 Then
            ...
            Me.txtCodigoEmpleado.Text = cFunciones.BuscarDatos2("select identificacion as Identificación,nombre as Nombre from Empleado", "Nombre", " ORDER BY Nombre", "Buscar Empleado ....", SqlConnection1.ConnectionString)
    ...
    Private Sub CheckEstado_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckEstado.CheckedChanged
        If Me.CBEstado.Visible = True Then
            Me.CBEstado.Visible = False
        Else
            Me.CBEstado.Visible = True
        End If
    End Sub
