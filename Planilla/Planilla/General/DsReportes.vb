...
Public Class DsReportes
    ...
    Public Class Planilla_DeduccionesDataTable
        ...
        Public Overloads Function AddPlanilla_DeduccionesRow(ByVal Id_PlanillaDetalle As Long, ByVal Cod_Deduccion As Integer, ByVal Nombre As String, ByVal Monto As Double, ByVal Cod_Moneda As Integer) As Planilla_DeduccionesRow
            ...
            rowPlanilla_DeduccionesRow.ItemArray = New Object() {Nothing, Id_PlanillaDetalle, Cod_Deduccion, Nombre, Monto, Cod_Moneda}
    ...
    Public Class Planilla_DetalleDataTable
        ...
        Public Overloads Function AddPlanilla_DetalleRow( _
            ...
            rowPlanilla_DetalleRow.ItemArray = New Object() {Nothing, Id_Planilla, Cedula, Nombre, Puesto, Salario, FormaPago, Ordinaria, Extra, Doble, SalarioBruto, Adelantos, Prestamos, Renta, TotalDeducciones, SalarioNeto, Cod_Moneda}
