...
Public Class ReportePlanilla2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ReportePlanilla2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Proyecto() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportePlanilla2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePlanilla2 = New ReportePlanilla2()
        rpt.Site = Me.Site
        Return rpt
    End Function
