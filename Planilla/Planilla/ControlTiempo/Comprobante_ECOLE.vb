...
Public Class Comprobante_ECOLE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.Comprobante_ECOLE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedComprobante_ECOLE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Comprobante_ECOLE = New Comprobante_ECOLE()
        rpt.Site = Me.Site
        Return rpt
    End Function
