...
Public Class ReportePlanillaBorinque
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "ReportePlanillaBorinque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePlanillaBorinque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePlanillaBorinque = New ReportePlanillaBorinque
        rpt.Site = Me.Site
        Return rpt
    End Function
