...
Public Class ReportePlanilla3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ReportePlanilla3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePlanilla3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePlanilla3 = New ReportePlanilla3()
        rpt.Site = Me.Site
        Return rpt
    End Function
