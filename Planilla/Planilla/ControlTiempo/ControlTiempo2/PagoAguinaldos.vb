...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.TituloModulo.Text = "Pago Aguinaldo Automática Bancos"
        '
        'cmbBanco
        '
...
#Region "Funciones Generar Archivo BN"
    ...
    Private Sub RegistroCredito(ByRef Escribe As StreamWriter)
        ...
        sql = "SELECT E.CuentaBancaria, PD.Aguinaldo AS SalarioNeto FROM Aguinaldos PD INNER JOIN Empleado E ON PD.Cedula = E.Identificacion COLLATE Modern_Spanish_CI_AS WHERE (E.CuentaBancaria <> '')"
    ...
    Private Function ObtenerSumatoriaMonto() As String
        ...
        sql = "SELECT ROUND(SUM(Aguinaldos.Aguinaldo) * 2, 2) AS Expr1 FROM Aguinaldos INNER JOIN Empleado ON Aguinaldos.Cedula COLLATE SQL_Latin1_General_CP1_CI_AS = Empleado.Identificacion WHERE (Empleado.CuentaBancaria <> '')"
    ...
    Private Function ObtenerMontoDebito() As String
        ...
        sql = "SELECT SUM(round(Aguinaldo,2)) As Resultado FROM Aguinaldos"
    ...
    Private Function ObtenerSumatoriaCuentas() As String
        ...
        sql = "SELECT E.CuentaBancaria FROM Aguinaldos PD INNER JOIN Empleado E ON PD.Cedula COLLATE SQL_Latin1_General_CP1_CI_AS = E.Identificacion"
