...
Public Class DsContabilidad
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DsContabilidad.xsd"
    ...
    Public Class AsientosContablesDataTable
        ...
        Public Overloads Function AddAsientosContablesRow(ByVal Fecha As Date, ByVal NumDoc As Decimal, ByVal Beneficiario As String, ByVal TipoDoc As Integer, ByVal Accion As String, ByVal Anulado As Boolean, ByVal FechaEntrada As Date, ByVal Mayorizado As Boolean, ByVal Periodo As String, ByVal NumMayorizado As Decimal, ByVal Modulo As String, ByVal Observaciones As String, ByVal NombreUsuario As String, ByVal TotalDebe As Double, ByVal TotalHaber As Double) As AsientosContablesRow
            Dim rowAsientosContablesRow As AsientosContablesRow = CType(Me.NewRow,AsientosContablesRow)
            rowAsientosContablesRow.ItemArray = New Object() {Nothing, Fecha, NumDoc, Beneficiario, TipoDoc, Accion, Anulado, FechaEntrada, Mayorizado, Periodo, NumMayorizado, Modulo, Observaciones, NombreUsuario, TotalDebe, TotalHaber}
