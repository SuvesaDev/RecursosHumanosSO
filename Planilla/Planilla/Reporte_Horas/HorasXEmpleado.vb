...
Public Class HorasXEmpleado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.HorasXEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHorasXEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HorasXEmpleado = New HorasXEmpleado()
        rpt.Site = Me.Site
        Return rpt
    End Function
