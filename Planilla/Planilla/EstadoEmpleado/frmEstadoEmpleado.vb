...
#End Region
    ...
    Private Function Buscar()
        ...
        Try
            ...
            Me.DsEstadoEmpleado1.Estado_Empleado.Clear()
            Id = funcion.BuscarDatos("Select Codigo as Identificador, Descripcion as Nombre from Estado_Empleado", "Descripcion", "Buscar Estado del Empleado ...", SqlConnection1.ConnectionString)
            buscando = True
