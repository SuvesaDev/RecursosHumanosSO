...
Public Class ReporteChecke
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ReporteChecke.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Planilla() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteChecke
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteChecke = New ReporteChecke()
        rpt.Site = Me.Site
        Return rpt
    End Function
