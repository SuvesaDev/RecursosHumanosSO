...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    Public Sub New()
        ...
        If NuevaConexion <> "" Then Me.SqlConnection.ConnectionString = NuevaConexion Else Me.SqlConnection.ConnectionString = GetSetting("SeeSOFT", "Planilla", "Conexion")
...
#End Region
    ...
    Private Sub BuscarDatos(ByVal Descripcion As String)
        ...
        If strNumeroDocumento Is Nothing Then '#1

            'Si no se inicializo la variable numero documento buscara solo por CampoFiltro
            DV.RowFilter = CampoFiltro & " lIKE '%" & Descripcion & "%'" & IIf(Me.CkeckBuscaFecha.Checked = True, " AND " & CampoFecha & " >= '" & CType(Fecha1.Value, Date) & "' AND " & CampoFecha & " <= '" & DateAdd(DateInterval.Day, 1, Fecha2.Value) & "'", "")

        Else '#1
            'Si se inicializo la variable strNumeroDocumento verifico el tipo de busqueda 
