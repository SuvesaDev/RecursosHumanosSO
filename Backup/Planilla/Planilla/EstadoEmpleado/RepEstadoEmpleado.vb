...
Public Class RepEstadoEmpleado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.RepEstadoEmpleado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepEstadoEmpleado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepEstadoEmpleado = New RepEstadoEmpleado
        rpt.Site = Me.Site
        Return rpt
    End Function
