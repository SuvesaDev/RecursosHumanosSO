...
Public Class AccionPersonales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.AccionPersonales.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Id_Empleado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAccionPersonales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccionPersonales = New AccionPersonales
        rpt.Site = Me.Site
        Return rpt
    End Function
