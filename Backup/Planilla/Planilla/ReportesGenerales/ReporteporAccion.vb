...
Public Class ReporteporAccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ReporteporAccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteporAccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteporAccion = New ReporteporAccion
        rpt.Site = Me.Site
        Return rpt
    End Function
