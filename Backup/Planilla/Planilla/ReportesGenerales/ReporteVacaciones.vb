...
Public Class ReporteVacaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.ReporteVacaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteVacaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteVacaciones = New ReporteVacaciones
        rpt.Site = Me.Site
        Return rpt
    End Function
