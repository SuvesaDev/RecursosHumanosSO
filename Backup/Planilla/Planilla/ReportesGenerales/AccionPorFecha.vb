...
Public Class AccionPorFecha
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.AccionPorFecha.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccionPorFecha
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccionPorFecha = New AccionPorFecha
        rpt.Site = Me.Site
        Return rpt
    End Function
