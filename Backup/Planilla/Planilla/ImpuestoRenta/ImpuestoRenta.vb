...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.txtExento.Size = New System.Drawing.Size(96, 21)
        ...
        'btnAceptar
        '
        Me.btnAceptar.Location = New System.Drawing.Point(56, 328)
        ...
        Me.txtDesde2.Size = New System.Drawing.Size(96, 21)
        ...
        Me.txtHasta1.Size = New System.Drawing.Size(96, 21)
        ...
        Me.txtDesde1.Size = New System.Drawing.Size(96, 21)
        ...
        Me.txtHijo.Size = New System.Drawing.Size(112, 21)
        ...
        Me.txtEsposo.Size = New System.Drawing.Size(112, 21)
        ...
        'btnCancelar
        '
        Me.btnCancelar.Location = New System.Drawing.Point(192, 328)
        ...
        "AND (Porcentaje2 = @Original_Porcentaje2) AND (TipoCambioSRD = @Original_TipoCam" & _
        "bioSRD)"
        ...
        Me.SqlDeleteCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TipoCambioSRD", System.Data.SqlDbType.Float, 8, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "TipoCambioSRD", System.Data.DataRowVersion.Original, Nothing))
        '
        'SqlInsertCommand1
        '
        Me.SqlInsertCommand1.CommandText = "INSERT INTO ParametroRenta(MontoExento, MontoDe, MontoHasta, Porcentaje1, MontoEn" & _
        "Adelante, Porcentaje2, Esposa, Hijo, TipoCambioSRD) VALUES (@MontoExento, @Monto" & _
        "De, @MontoHasta, @Porcentaje1, @MontoEnAdelante, @Porcentaje2, @Esposa, @Hijo, @" & _
        "TipoCambioSRD); SELECT Id, MontoExento, MontoDe, MontoHasta, Porcentaje1, MontoE" & _
        "nAdelante, Porcentaje2, Esposa, Hijo, TipoCambioSRD FROM ParametroRenta WHERE (I" & _
        "d = @@IDENTITY)"
        ...
        Me.SqlInsertCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TipoCambioSRD", System.Data.SqlDbType.Float, 8, "TipoCambioSRD"))
        '
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "SELECT Id, MontoExento, MontoDe, MontoHasta, Porcentaje1, MontoEnAdelante, Porcen" & _
        "taje2, Esposa, Hijo, TipoCambioSRD FROM ParametroRenta"
        ...
        "e, Porcentaje2 = @Porcentaje2, Esposa = @Esposa, Hijo = @Hijo, TipoCambioSRD = @" & _
        "TipoCambioSRD WHERE (Id = @Original_Id) AND (Esposa = @Original_Esposa) AND (Hij" & _
        "o = @Original_Hijo) AND (MontoDe = @Original_MontoDe) AND (MontoEnAdelante = @Or" & _
        "iginal_MontoEnAdelante) AND (MontoExento = @Original_MontoExento) AND (MontoHast" & _
        "a = @Original_MontoHasta) AND (Porcentaje1 = @Original_Porcentaje1) AND (Porcent" & _
        "aje2 = @Original_Porcentaje2) AND (TipoCambioSRD = @Original_TipoCambioSRD); SEL" & _
        "ECT Id, MontoExento, MontoDe, MontoHasta, Porcentaje1, MontoEnAdelante, Porcenta" & _
        "je2, Esposa, Hijo, TipoCambioSRD FROM ParametroRenta WHERE (Id = @Id)"
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@TipoCambioSRD", System.Data.SqlDbType.Float, 8, "TipoCambioSRD"))
        ...
        Me.SqlUpdateCommand1.Parameters.Add(New System.Data.SqlClient.SqlParameter("@Original_TipoCambioSRD", System.Data.SqlDbType.Float, 8, System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "TipoCambioSRD", System.Data.DataRowVersion.Original, Nothing))
        ...
        Me.GroupBox3.Size = New System.Drawing.Size(344, 80)
        Me.GroupBox3.TabIndex = 4
        Me.GroupBox3.TabStop = False
        Me.GroupBox3.Text = "Salario de Referencia en Dolares (SRD)"
        '
        'Button1
        '
        Me.Button1.Location = New System.Drawing.Point(128, 24)
        Me.Button1.Name = "Button1"
        Me.Button1.Size = New System.Drawing.Size(120, 40)
        Me.Button1.TabIndex = 2
        Me.Button1.Text = "Ejecutar Ajuste"
        '
        'TextEdit2
        '
        Me.TextEdit2.DataBindings.Add(New System.Windows.Forms.Binding("EditValue", Me.DataSetParametro1, "ParametroRenta.TipoCambioSRD"))
        Me.TextEdit2.EditValue = ""
        Me.TextEdit2.Location = New System.Drawing.Point(8, 40)
...
#End Region
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If MsgBox("Desea ajustar los salarios con el nuevo tipo de cambio", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            correrTransformacion()
        End If

    End Sub
    Sub correrTransformacion()
        Try

            Dim dt As New DataTable
            cFunciones.Llenar_Tabla_Generico("Select * From Empleado WHERE SRD > 0 ", dt, GetSetting("SeeSoft", "Planilla", "Conexion"))
            For i As Integer = 0 To dt.Rows.Count - 1
                Dim cx As New Conexion
                cx.Conectar()
                Dim resp As String = cx.SlqExecute(cx.sQlconexion, "UPDATE Empleado SET Salario = " & dt.Rows(i).Item("SRD") * Me.TextEdit2.EditValue & " WHERE Identificacion = '" & dt.Rows(i).Item("Identificacion") & "'")
                If Not (resp Is Nothing) Then
                    MsgBox("Error a ejecutar el cambio RESULTADO: " & resp)
                End If
