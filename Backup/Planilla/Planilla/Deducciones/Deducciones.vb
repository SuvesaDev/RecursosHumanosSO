...
#End Region
    ...
    Private Sub Deducciones_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            adMoneda.Fill(Me.Deduccion1, "Moneda")
            Deduccion1.Deducciones.DescripcionColumn.DefaultValue = ""
            Deduccion1.Deducciones.MontoColumn.DefaultValue = 0
            Deduccion1.Deducciones.TipoColumn.DefaultValue = ""
            Deduccion1.Deducciones.AplicaColumn.DefaultValue = 0
            Deduccion1.Deducciones.Cod_MonedaColumn.DefaultValue = 0
    ...
    Private Function Buscar()
        ...
        Dim Id As String
        Dim con As String = GetSetting("SeeSoft", "Planilla", "Conexion")
        Try
            Me.Deduccion1.Deducciones.Clear()
            LimpiarCuentaContable()
            Id = funcion.BuscarDatos("Select Codigo As Identificación, Descripcion as Nombre from Deducciones", "Descripcion", "Buscar Deducción ...", con)
            buscando = True
        ...
        Select Case ToolBar1.Buttons.IndexOf(e.Button) + 1
            ...
            Case 3
                If Me.BindingContext(Deduccion1, "Deducciones").Count > 0 Then '#1
                    ...
                    Dim strDel As String = Me.BindingContext(Deduccion1, "Deducciones").Current("Codigo")
                    Dim rs As SqlDataReader
                    rs = Cconexion.GetRecorset(Cconexion.Conectar("Planilla"), "SELECT Identificacion FROM Empleado_Deducciones WHERE Codigo =" & strDel)
