...
Public Class cFunciones
    ...
    Public Function BuscarDatos2(ByVal strConsulta As String, ByVal campo As String, ByVal pSqlAdicional As String, Optional ByVal nombre As String = "Buscar...", Optional ByVal NuevaConexionStr As String = "", Optional ByVal Fecha As Integer = 0) As String
        Dim frmBuscar As New Buscar
        Dim codigo As String
        Fechaemp = Fecha
        frmBuscar.sqlString = strConsulta
