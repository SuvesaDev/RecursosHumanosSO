Public Module CrystalReportsConexion
    Public Function LoadReportViewer(ByRef Viewer As CrystalDecisions.Windows.Forms.CrystalReportViewer, ByVal objReport As CrystalDecisions.CrystalReports.Engine.ReportDocument, Optional ByVal NoShow As Boolean = False) As Boolean
        ...
        SQLConexion.SQLStringConexion = GetSetting("Seesoft", "Planilla", "Conexion")
        SQLConexion.Conectar("Planilla")
