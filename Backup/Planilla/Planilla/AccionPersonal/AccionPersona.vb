...
Public Class AccionPersona
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.AccionPersona.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NumeroAccion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedAccionPersona
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccionPersona = New AccionPersona
        rpt.Site = Me.Site
        Return rpt
    End Function
