...
Public Class GeneralXFechas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Planilla.GeneralXFechas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGeneralXFechas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneralXFechas = New GeneralXFechas
        rpt.Site = Me.Site
        Return rpt
    End Function
