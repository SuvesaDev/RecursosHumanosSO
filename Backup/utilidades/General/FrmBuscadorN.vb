...
#Region " Código generado por el Diseñador de Windows Forms "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.CheckBox1.Text = "Buscar por número de factura"
        '
        'cbxTipo
        '
        Me.cbxTipo.DisplayMember = "CON"
        Me.cbxTipo.Enabled = False
        Me.cbxTipo.Items.AddRange(New Object() {"CON", "CRE"})
        Me.cbxTipo.Location = New System.Drawing.Point(323, 351)
        ...
        Me.TextBox1.Location = New System.Drawing.Point(179, 352)
...
#End Region
    Private Sub FrmBuscador_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case CanColums
            Case 5 : Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.GridColumn1, Me.GridColumn4, Me.GridColumn2, Me.GridColumn3, Me.gridColumn5})
            ...
            Case Else
                ...
                Me.GridColumn5.FieldName = DataSet.Tables(0).Columns(3).Caption()

                Me.GridColumn1.Caption = DataSet.Tables(0).Columns(0).Caption()
                Me.GridColumn2.Caption = DataSet.Tables(0).Columns(1).Caption()
                Me.GridColumn3.Caption = DataSet.Tables(0).Columns(2).Caption()
                Me.GridColumn5.Caption = DataSet.Tables(0).Columns(3).Caption()
